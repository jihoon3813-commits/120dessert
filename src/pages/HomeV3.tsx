          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div className="max-w-3xl mb-16" {...fadeIn}>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4 tracking-tight leading-tight">
                단순한 디저트 납품을 넘어,<br />
                강력한 <span className="text-amber-400">매장 이익 극대화 솔루션</span>을 이식합니다.
              </h2>
              <p className="text-xs sm:text-sm text-neutral-400 font-bold leading-relaxed max-w-xl">
                120겹 파이와 에그120의 검증된 수익 공식이 사장님 매장 카운터 및 배달앱 내부에서 시너지로 가동됩니다.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(200px,_auto)]">
              ...
              >
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-neutral-400 font-medium leading-relaxed">
                    아메리카노 단독 결제 고객들을 본사 특제 120파이 혹은 에그120 세트 페어링 구성으로 자연스럽게 유도합니다. 1인 결제액을 극적으로 보정하고 마진율을 확보합니다.
                  </p>
                </div>
                <div className="flex flex-wrap gap-2 mt-6">
                  ...
                  <span className="px-2.5 py-1 rounded bg-neutral-950 border border-neutral-850 text-[10px] font-bold text-amber-400">마진율 극대화</span>
                </div>
              </motion.article>
              ...
              >
                <img 
                  ...
                  className="w-full h-full object-cover opacity-75 hover:opacity-100 hover:scale-102 transition-all duration-500" 
                />
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-neutral-400 font-medium leading-relaxed">
                    인테리어 거품 마진 제로, 기존 카페 인프라에 소형 쇼케이스 기물과 브랜드 엠블럼 병기만으로 즉시 가볍게 시작합니다.
                  </p>
                </div>
              </motion.article>
              ...
              >
                <div>
                  <span className="w-8 h-8 rounded bg-neutral-950 border border-neutral-800 flex items-center justify-center font-bold text-sm mb-4">⚡</span>
                  <h3 className="text-base font-black text-white mb-2">숙련자 없는 5분 조리 매뉴얼</h3>
                  <p className="text-xs text-neutral-400 font-medium leading-relaxed">
                    어려운 기술 불필요. 본사 신선 물류 시스템을 통해 오븐 기구에 넣고 버튼만 누르면 전문 수준의 조리가 완결됩니다.
                  </p>
                </div>
              </motion.article>
              ...
              >
                <div>
                  ...
                  <h3 className="text-base font-black text-white mb-2">상온 폐기 원재료 손실 ZERO</h3>
                  <p className="text-xs text-neutral-400 font-medium leading-relaxed">
                    신선 냉동 물류 공급 생지는 급냉 보존되어 당일 판매 여부와 상관없이 필요 수량만큼만 구워내 폐기 원가 리스크가 없습니다.
                  </p>
                </div>
              </motion.article>
        ...
        <section id="structure" className="py-24 bg-neutral-950 text-white overflow-hidden relative border-b border-neutral-900/80">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
             <motion.div className="max-w-3xl mx-auto mb-16" {...fadeIn}>
               ...
               <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4 text-white">브랜드 구조는 하나로, 시너지는 거대하게</h2>
               <p className="text-xs sm:text-base text-neutral-450 font-medium max-w-xl mx-auto">
                  120pie&coffee는 시그니처 대표 축인 120파이와 바이럴 성장의 엔진 에그120을 결합하여, 다양한 상권 맞춤형 모듈 비즈니스를 전개합니다.
               </p>
             </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                  ...
                  <div className="bg-neutral-950 rounded-2xl border border-neutral-850 relative z-10 flex flex-col items-center overflow-hidden hover:border-amber-400/40 transition-colors">
                    <div className="h-28 w-full overflow-hidden bg-neutral-900">
                      <img src="https://images.unsplash.com/photo-1555507036-ab1f4038808a?q=80&w=300&fit=crop" alt="" className="w-full h-full object-cover opacity-60" />
                    </div>
                    <div className="p-5 flex flex-col items-center">
                      <div className="text-[10px] font-bold text-amber-400 mb-1.5 tracking-widest uppercase">Hero Core</div>
                      <div className="text-lg font-black text-white mb-1">120겹파이 시리즈</div>
                      <div className="text-xs text-neutral-400 text-center font-medium">겉바속촉 시그니처 식사 &amp; 디저트 주축</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-neutral-950 rounded-2xl border border-neutral-850 relative z-10 flex flex-col items-center overflow-hidden hover:border-amber-400/40 transition-colors">
                    <div className="h-28 w-full overflow-hidden bg-neutral-900">
                      <img src="https://images.unsplash.com/photo-1587314168485-3236d6710814?q=80&w=300&fit=crop" alt="" className="w-full h-full object-cover opacity-60" />
                    </div>
                    <div className="p-5 flex flex-col items-center">
                      <div className="text-[10px] font-bold text-green-400 mb-1.5 tracking-widest uppercase">Growth Engine</div>
                      <div className="text-lg font-black text-white mb-1">에그120 계란빵</div>
                      <div className="text-xs text-neutral-400 text-center font-medium">쌀가루 반죽 특색의 SNS 바이럴 엔진</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-neutral-950 rounded-2xl border border-neutral-850 relative z-10 flex flex-col items-center overflow-hidden hover:border-amber-400/40 transition-colors">
                    <div className="h-28 w-full overflow-hidden bg-neutral-900">
                      <img src="https://images.unsplash.com/photo-1561571994-3c61c554181a?q=80&w=300&fit=crop" alt="" className="w-full h-full object-cover opacity-60" />
                    </div>
                    <div className="p-5 flex flex-col items-center">
                      <div className="text-[10px] font-bold text-blue-400 mb-1.5 tracking-widest uppercase">Expansion Module</div>
                      <div className="text-lg font-black text-white mb-1">츄러스 · 핫도그 · 수프</div>
                      <div className="text-xs text-neutral-400 text-center font-medium">오피스/대학가 등 맞춤형 추가 강화 모듈</div>
                    </div>
                  </div>
                </div>
             </div>
        ...
        <section id="contact" className="py-24 bg-gradient-to-b from-[#0a0a0a] to-[#050505] text-white relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <span className="text-amber-400 font-bold tracking-widest text-xs uppercase mb-2 block font-mono">Premium Inquiry</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight mb-4 leading-tight">
                지금 사장님 매장 카운터에<br />매출 성장의 모듈을 얹으세요
              </h2>
              <p className="text-xs sm:text-base text-neutral-400 font-medium leading-relaxed max-w-xl mx-auto">
                가장 가벼운 샵인샵 도입부터 공동간판, 단독 가맹 리모델링 상담까지. 아래의 간편 정보를 기입해 주시면 무료 견적 진단서와 카탈로그를 보내드립니다.
              </p>
            </div>
            ...
            <div className="max-w-xl mx-auto bg-neutral-900 border border-neutral-850 rounded-3xl p-6 sm:p-10 shadow-2xl relative">
              ...
              {formSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-white mt-4">상담 신청이 정상 접수되었습니다!</h3>
                  <p className="text-xs sm:text-sm text-neutral-400 max-w-sm font-medium leading-relaxed">
                    120pie&amp;coffee의 전문 카운슬러가 입력해 주신 연락처로 24시간 이내에 전화를 드려 무료 상권 분석 및 상세 도입 단가를 친절히 진단해 드리겠습니다.
                  </p>
                </motion.div>
              ) : (
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-neutral-355">희망 가맹 도입 형태</label>
                      <select 
                        name="storeType"
                      ...
                      >
                        <option value="샵인샵 도입">가벼운 샵인샵 도입 (100만원대)</option>
                        <option value="브랜드 병기 도입">확실한 브랜드 표기 도입</option>
                        <option value="공동간판 제휴">시너지 극대화 공동간판 제휴</option>
                        <option value="단독 매장 전환">단독 매장 완전 리모델링 전환</option>
                        <option value="신규 무점포/창업">신규 단독 매장 무점포/창업</option>
                      </select>
                    </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-xs font-bold text-neutral-355">상세 문의 내용 (선택)</label>
                    <textarea 
                      name="message"
                      value={formData.message}
                      onChange={handleFormChange}
                      rows={3}
                      placeholder="매장 규모, 현재 취급 기물, 상권 특징 등 문의사항을 자유롭게 남겨주세요." 
                  ...
                  <div className="flex items-start gap-2 pt-2">
                    ...
                    <label htmlFor="privacy" className="text-[10px] text-neutral-500 leading-normal font-bold">
                      개인정보 수집 및 마케팅/전화상담 목적 활용에 동의합니다. (필수)
                    </label>
                  </div>
